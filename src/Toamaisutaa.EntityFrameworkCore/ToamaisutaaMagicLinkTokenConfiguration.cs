...
public sealed class ToamaisutaaMagicLinkTokenConfiguration : IEntityTypeConfiguration<ToamaisutaaMagicLinkToken>
{
    public const string TableName = "ToamaisutaaMagicLinkTokens";

    public void Configure(EntityTypeBuilder<ToamaisutaaMagicLinkToken> builder)
    {
