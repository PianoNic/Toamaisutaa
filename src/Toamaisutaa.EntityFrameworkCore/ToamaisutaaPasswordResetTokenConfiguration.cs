...
public sealed class ToamaisutaaPasswordResetTokenConfiguration : IEntityTypeConfiguration<ToamaisutaaPasswordResetToken>
{
    public const string TableName = "ToamaisutaaPasswordResetTokens";

    public void Configure(EntityTypeBuilder<ToamaisutaaPasswordResetToken> builder)
    {
